...
// HELMETS
class S_Helmet_SPAGPAT: rhssaf_helmet_m97_black_nocamo
{
  scope = 2;
  scopeArsenal = 2;
  author= "Taepodong/Kalthramis";
  displayName = "Combat Helm (SPAGPAT)";
  hiddenSelectionsTextures[] = { QPATHTOF(hats\helm.paa) };
  descriptionShort = "Spagistan Helmet";
};
//QPATHTOF(hats\helm.paa)
class S_Helmet_SPAGPAT_black_ess: rhssaf_helmet_m97_woodland_black_ess
{
  ...
  hiddenSelectionsTextures[] = { QPATHTOF(hats\helm.paa), QPATHTOF(hats\rhssaf_m97_ess_black_co.paa) };
};
...
class S_PatrolCap_SPAGPAT: rhsusf_patrolcap_ucp
{
    ...
    scope = 2;
    hiddenSelectionsTextures[] = { QPATHTOF(hats\PatrolCap_SPAGPAT_ca.paa)};
};
